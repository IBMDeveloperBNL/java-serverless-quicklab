...
## 0. Setup
1. Go to this link and create an IBM Cloud Account: https://ibm.biz/BdqSfY.

2. If you already have an account, go to the same [link](https://ibm.biz/BdqSfY) and click **Log in** on the top right of the page to continue.
